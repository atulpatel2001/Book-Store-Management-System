...
public class EmailService {
    ...
    private final String password = "bxnukgexciyglqfn";
    private final String userName = "onlinebook.store.2024@gmail.com";

    private final String from = "onlinebook.store.2024@gmail.com";
